...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.skills": "技能",
    "common.plugins": "插件",
    "brainstorm.title": "头脑风暴",
    "brainstorm.activeTitle": "头脑风暴模式进行中",
    "brainstorm.activeHint": "只读模式 — 结束后会生成决策简报",
    "brainstorm.hint": "只读模式，自由讨论一个主题",
    "brainstorm.start": "开始头脑风暴",
    "brainstorm.endAndSummarize": "结束并总结",
    "brainstorm.endTitle": "结束头脑风暴模式并生成决策简报",
    "brainstorm.cancelAndDiscard": "取消并丢弃",
    "brainstorm.discardTitle": "不生成总结直接丢弃头脑风暴",
    "brainstorm.continue": "继续讨论",
    "brainstorm.cancel": "取消",
    "brainstorm.placeholder": "输入主题，例如：为独立开发者设计一个找早期用户的产品",
    "brainstorm.toggleActive": "头脑风暴进行中 — 点击结束并生成总结",
    "brainstorm.toggleHint": "以只读模式头脑风暴一个主题",
    "brainstorm.brainstorming": "头脑风暴中",
    "brainstorm.freeChatHint": "自由讨论 — 结束会话前文件编辑和 shell 命令会被阻止",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "切换到浅色模式",
    "theme.dark": "切换到深色模式",
    ...
    "chat.syncModels": "同步模型列表",
    "chat.syncModelsFailed": "模型同步失败，请重试",
