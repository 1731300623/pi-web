...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "brainstorm.activeTitle": "Brainstorm mode is active",
    "brainstorm.activeHint": "Read-only — ending produces a decision brief",
    "brainstorm.hint": "Read-only mode, freely discuss a topic",
    "brainstorm.start": "Start brainstorm",
    "brainstorm.endAndSummarize": "End and summarize",
    "brainstorm.endTitle": "End brainstorm mode and generate a decision brief",
    "brainstorm.cancelAndDiscard": "Cancel and discard",
    "brainstorm.discardTitle": "Discard the brainstorm without a summary",
    "brainstorm.continue": "Continue discussing",
    "brainstorm.cancel": "Cancel",
    "brainstorm.placeholder": "Enter a topic, e.g. a product idea for indie developers",
    "brainstorm.toggleActive": "Brainstorm mode is active — click to end and summarize",
    "brainstorm.toggleHint": "Brainstorm a topic in read-only mode",
    "brainstorm.brainstorming": "Brainstorming",
    "brainstorm.freeChatHint": "Chat freely — file edits and shell commands are blocked until you end the session",
    ...
    "chat.syncModels": "Sync model list",
    "chat.syncModelsFailed": "Failed to sync models",
